...
AUTO_INCREMENT=13 AVG_ROW_LENGTH=3276 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
AUTO_INCREMENT=44 AVG_ROW_LENGTH=5461 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
AUTO_INCREMENT=20 AVG_ROW_LENGTH=4096 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
AUTO_INCREMENT=20 AVG_ROW_LENGTH=1365 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
AUTO_INCREMENT=15 AVG_ROW_LENGTH=606 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
AUTO_INCREMENT=11 AVG_ROW_LENGTH=528 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
AUTO_INCREMENT=31 AVG_ROW_LENGTH=819 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
AUTO_INCREMENT=51 AVG_ROW_LENGTH=16384 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
CREATE TABLE `giro` (
  ...
  `logo` VARCHAR(120) COLLATE utf8_general_ci DEFAULT NULL,
...
AUTO_INCREMENT=15 AVG_ROW_LENGTH=1820 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
AUTO_INCREMENT=10 AVG_ROW_LENGTH=2730 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
AUTO_INCREMENT=36 AVG_ROW_LENGTH=5461 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
#
# Data for the `banner` table  (LIMIT -451,500)
#
...
INSERT INTO `usuario` (`idUsuario`, `nombre`, `apellido`, `telefono`, `correo`, `contrasena`, `recepcionCorreo`, `tipoUsuario`, `status`, `nivel`, `codigoConfirmacion`, `fechaRegistro`, `useragent`, `last_ip_access`, `authKey`, `paqueteGratis`) VALUES
  ...
  (2,'admin','admin',1111,'admin@gmail.com','2e0e4da5c11c0f8a73a01a5ddd672211af58c5b1e5179d7412',0,0,1,0,'A7995E2C507D113EF045E8BE6','2014-07-14 21:23:15',NULL,NULL,'120BAB4E490AE180FE6F',1),
  (3,'martha','hdez',1234567890,'marthahdez2@gmail.com','5287afd7bed68e3269996f00f446240dcaca0224a6405f1d56',1,3,1,3,'EA5A0F1E6DD8358A5ECDC3C6C','2014-07-17 17:24:18',NULL,NULL,'4A0CA0053FB797236DC8',1),
...
#
# Data for the `compradetalle` table  (LIMIT -480,500)
#
...
#
# Data for the `contenido` table  (LIMIT -487,500)
#
...
#
# Data for the `serviciocontratado` table  (LIMIT -487,500)
#
...
#
# Data for the `cuponadquirido` table  (LIMIT -491,500)
#
...
#
# Data for the `fotoscontenido` table  (LIMIT -489,500)
#
...
#
# Data for the `fotospublicacion` table  (LIMIT -449,500)
#
...
#
# Data for the `publicaciones` table  (LIMIT -487,500)
#
...
INSERT INTO `publicaciones` (`publicacionID`, `seccion`, `titulo`, `vigente`, `fechaCreacion`, `fechaVencimiento`, `numeroVisitas`, `estadoID`, `genero`, `razaID`, `precio`, `descripcion`, `muestraTelefono`, `aprobada`, `servicioID`, `detalleID`, `paqueteID`, `ciudad`) VALUES
  ...
  (3,2,'qwerty',1,'2014-10-15','2014-11-14',0,22,0,'11',999.99,'eeeeeeeeeeeeee',1,0,3,1,1,'qwertyu'),
  (4,6,'qwertyui',1,'2014-10-15','2014-11-14',0,22,0,'8',0.00,'qwwwwwww',1,1,4,1,1,'qwwqw'),
  (5,4,'publicacion de directorio',1,'2014-10-15','2014-10-30',0,0,0,'1',100.00,'',0,0,5,2,2,NULL),
  (6,4,'publicacion de directorio',1,'2014-10-16','2014-10-31',0,22,0,'1',100.00,'QUERETARO QUERETARO QUERETARO QUERETARO',1,0,6,2,2,NULL),
...
#
# Data for the `usuariodato` table  (LIMIT -492,500)
#
...
INSERT INTO `usuariodato` (`idUsuarioDato`, `idUsuario`, `razonSocial`, `rfc`, `calle`, `noInterior`, `noExterior`, `cp`, `municipio`, `estadoID`, `idPais`) VALUES
  ...
  (2,2,'','','','0','',0,'',0,147),
  (3,3,'','','2345','0','3456',23456,'QUERETARO',22,146),
  (4,4,'','','','0','',0,'',0,147),
...
#
# Data for the `videos` table  (LIMIT -466,500)
#
