...
INSERT INTO `contenido` (`contenidoID`, `seccionID`, `seccionDetalle`, `texto`, `fecha`, `zonaID`, `nombre`, `mes`, `origenes`, `caracter`, `cualidades`, `colores`, `acercaDe`, `horario`, `lugar`, `domicilio`) VALUES
  ...
  (5,8,'Raza del mes','','2014-08-24',9,'5','Junio','El Bichón maltés es una raza de perro de tamaño pequeño que surgió en el Mediterráneo central siendo Italia quien tomó el patrocinio. El nombre de la raza y el origen son, generalmente, asociados a la isla mediterránea de Malta, sin embargo, el nombre es a veces descrito con referencia a la isla de Mljet o Meleda','El Bichón maltés es una raza de perro de tamaño pequeño que surgió en el Mediterráneo central siendo Italia quien tomó el patrocinio. El nombre de la raza y el origen son, generalmente, asociados a la isla mediterránea de Malta, sin embargo, el nombre es a veces descrito con referencia a la isla de Mljet o Meleda','El Bichón maltés es una raza de perro de tamaño pequeño que surgió en el Mediterráneo central siendo Italia quien tomó el patrocinio. El nombre de la raza y el origen son, generalmente, asociados a la isla mediterránea de Malta, sin embargo, el nombre es a veces descrito con referencia a la isla de Mljet o Meleda','El Bichón maltés es una raza de perro de tamaño pequeño que surgió en el Mediterráneo central siendo Italia quien tomó el patrocinio. El nombre de la raza y el origen son, generalmente, asociados a la isla mediterránea de Malta, sin embargo, el nombre es a veces descrito con referencia a la isla de Mljet o Meleda','El Bichón maltés es una raza de perro de tamaño pequeño que surgió en el Mediterráneo central siendo Italia quien tomó el patrocinio. El nombre de la raza y el origen son, generalmente, asociados a la isla mediterránea de Malta, sin embargo, el nombre es a veces descrito con referencia a la isla de Mljet o Meleda',NULL,NULL,NULL),
