...
--
-- Servidor: localhost
-- Tiempo de generación: 20-01-2015 a las 13:35:52
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=16384 AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=1024 AUTO_INCREMENT=1 ;
...
('809e5cba2de9ca58fc04d56f3d2180a8', '189.234.185.253', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.99 Safari/537.36', 1421782343, 'a:2:{s:9:"user_data";s:0:"";s:6:"banner";a:0:{}}'),
('ddae7771ab4e350fe36b8da70de1c8fe', '189.234.185.253', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.99 Safari/537.36', 1421782184, 'a:2:{s:9:"user_data";s:0:"";s:6:"banner";a:0:{}}');
...
CREATE TABLE IF NOT EXISTS `compra` (
  ...
  KEY `usuarioID` (`usuarioID`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=5461 AUTO_INCREMENT=52 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=4096 AUTO_INCREMENT=27 ;
...
CREATE TABLE IF NOT EXISTS `productodetalle` (
  ...
  KEY `productoID` (`productoID`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=1260 AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=1820 AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=606 AUTO_INCREMENT=1 ;
...
(2, 'admin', 'admin', 1111, 'admin@gmail.com', '2e0e4da5c11c0f8a73a01a5ddd672211af58c5b1e5179d7412', 0, 0, 1, 0, 'A7995E2C507D113EF045E8BE6', '2014-07-14 21:23:15', NULL, NULL, '744C15929645F36C45D0', 1),
(3, 'martha', 'hdez', 1234567890, 'marthahdez2@gmail.com', '2e0e4da5c11c0f8a73a01a5ddd672211af58c5b1e5179d7412', 1, 1, 1, 1, '44A63B77D28010A2723F0C293', '2014-07-17 17:24:18', NULL, NULL, 'CD3E1FEE5ABD8E02D2F0', 1),
