...
<body>
  <style>.titulo_seccion {font-size: 60px;margin: 15px auto 0px;width: 990px;max-width: 990px;font-family: "titulos";color: #7EA715;height: 65px;line-height: 1em;    }    .contenedor_central {float: left;width: 795px;margin-top: -15px;    }  </style>
    ...
    <ul class="iconos_estatus">
      <li>
        ...
        <img class="iconos_flotantes2" onmouseout="mostrar_icono('horizontal_compras_mini');
                                 ocultar_icono('horizontal_compras');" id="horizontal_compras" src="<?php echo base_url() ?>images/compras_horizontal.png" onclick="window.location = '<?php echo base_url() ?>carrito';" />
      </li>
      <li>
  ...
  <?php $this->load->view('general/menu_view') ?>
    <div class="contenedor_contactar_previo" id="contenedor_contactar_previo" style=" display:none;">
      ...
      <div class="contactar_al_aunuciante">
        ...
        <strong> Nombre de usuario:</strong> Juanito Perez<br>
        <strong> Estado: </strong> Hidalgo<br>
        <strong> Ciudad: </strong> Actopan<br>
        <strong> Teléfono: </strong> 372829102374746<br><br>
        ...
        <textarea cols="50" onfocus="clear_textbox('comentarios_contacto', 'Comentarios')" id="comentarios_contacto" class="formu_contacto" rows="5">Comentarios</textarea><br><br>
    ...
    <div class="contenedor_buscado"></div>
    <div id="contenedor_central">
      <div id="espacio_izquierda" class="seccion_izquierda_secciones">
        <ul class="iconos" id="iconos_grandes">
          <li <?php if ($this->session->userdata('idUsuario') !== FALSE): ?> onclick="window.location='
            <?= base_url() ?>carrito';"
              <?php else: ?>
                <?php endif; ?>>
                  ...
                  <img src="<?php echo base_url() ?>images/compras.png" />
          </li>
          <li <?php if ($this->session->userdata('idUsuario') !== FALSE): ?>
            <?php else: ?> onclick="muestra('contenedor_login');oculta('envio_con');muestra('ingreso_normal');"
              <?php endif; ?>>
                <div class="indicador">
                ...
                <img src="<?php echo base_url() ?>images/sesion.png" />
          </li>
          <li <?php if ($this->session->userdata('idUsuario') !== FALSE): ?>
            <?php else: ?>onclick="muestra('contenedor_registro');"
              <?php endif; ?>>
                <div class="indicador">
                  <?php if ($this->session->userdata('idUsuario') !== FALSE): ?>
      ...
      <div class="contenedor_central">
        ...
        <form class="formCarrito">
          <table width="795" class="tabla_carrito">
            ...
            <?php
              ...
              <tr>
                <td>
                  <img src="<?php echo base_url() ?>images/productos/<?php echo ($product->foto != null) ? $product->foto : 'default.png' ?>" width="47" height="41" />
                </td>
                <td>
                  <?php echo $product->nombre ?>
                    <br> Talla:
                    <?php echo $product->talla ?>
                      <br> Color:
                ...
                <td>
                  ...
                  <input type="number" class="cantidad validate[required, min[1], max[99]]" value="<?php echo $product->cantidad ?>" name="cantidad" id="" data-rel="<?php echo $product->cartID ?>" />
                </td>
                <td>
              ...
              <?php endforeach; ?>
                <tr>
                  <td colspan="4">
                    <p class="subtotal">
                      <img src="images/cupon_perfil.png" width="34" height="27"> Cupones de descuento
                      <br>
                    ...
                    <div style="display: none;" id="los_cupones">
                      <?php if (!empty($cupones)): ?>
                        <p class="subtotal">
                          <br>
                          <?php foreach ($cupones as $cupon): ?>
                            <label>
                              <input type="radio" name="descuento" value="<?php echo $cupon->idCuponAdquirido ?>" class="descuento validate[required]" data-rel="<?php echo $carritototal->carritoTotalID ?>" <?php echo ($carritototal->descuento == $cupon->valor) ? 'checked=checked' : '' ?>/>
                              <?php echo $cupon->valor ?>% de descuento</label>
                            <br>
                            <?php endforeach; ?>
                              <label>
                                <input type="radio" name="descuento" class="descuento validate[required]" value="" data-rel="<?php echo $carritototal->carritoTotalID ?>" /> No usar cupones</label><br><br>
                        </p>
                        <?php else: ?>
                          <p class="subtotal">
                            <br>No hay cupones.</p>
                  ...
                  <td>
                    <p class="sub_cantidad"> - $
                      <?php echo number_format($carritototal->subtotal - $carritototal->totalPrecio, 2) ?>
                    </p>
                  </td>
                </tr>
                <tr>
                  <td colspan="4">
                    <p class="subtotal">
                      <img src="images/sobre_perfil.png" width="34" height="27"> Gastos de envío
                      <br>
                      ...
                      <div class="subtotal">
                          ...
                          <select id="direcciones">
                            ...
                            <?php if (!is_null($direcciones)): ?>
                              <?php foreach ($direcciones as $direccion): ?>
                                <option data-nombre="<?php echo $direccion->nombre ?>" data-apellido="<?php echo $direccion->apellido ?>" data-cp="<?php echo $direccion->cp ?>" data-calle="<?php echo $direccion->calle ?>" data-numero="<?php echo $direccion->numero ?>" data-colonia="<?php echo $direccion->colonia ?>"
                                data-estado="<?php echo $direccion->idEstado ?>">
                                  <?php echo $direccion->idusuarioDetalle ?>
                                </option>
                                <?php endforeach; ?>
                                  <?php endif; ?>
                          </select>
                        ...
                        <?php if($direccion_envio == null){ ?>
                          <div id="form_envio">
                            <div>
                              <label>Nombre:</label>
                              <input class="background_gris_mini validate[required] updateDestino" name="nombre" type="text" value="<?php echo $datosPersonales->nombre ?>" style="margin-right:27px;" />
                              <label>Apellidos:</label>
                              <input class="background_gris_mini updateDestino" name="apellidos" type="text" value="<?php echo $datosPersonales->apellido ?>" />
                            </div><br>
                            <div>
                              <label style="margin-right:34px;">C.P:</label>
                              <input class="background_gris_mini validate[required] updateDestino" name="cp" type="text" value="<?php echo $datosPersonales->cp ?>" style="margin-right:28px;" />
                              <label style="margin-right:28px;">Calle:</label>
                              <input class="background_gris_mini validate[required] updateDestino" name="calle" type="text" value="<?php echo $datosPersonales->calle ?>" />
                            </div><br>
                            <div>
                              <label>Número:</label>
                              <input name="noExterior" class="background_gris_mini validate[required] updateDestino" type="text" value="<?php echo $datosPersonales->numero ?>" style="margin-right:28px;" />
                              <label style="margin-right:8px;">Colonia:</label>
                              <input class="background_gris_mini validate[required] updateDestino" type="text" name="colonia" value="<?php echo $datosPersonales->colonia ?>" />
                            </div><br>
                            <div>
                              <label>Ciudad:</label>
                              <input class="background_gris_mini validate[required] updateDestino" type="text" name="ciudad" value="<?php echo $datosPersonales->municipio ?>" style=" margin-right:31px;" />
                              <label style="margin-right:14px;">Estado:</label>
                              <select class="background_gris_mini validate[required] destino updateDestino" name="idEstado">
                                <option> ---</option>
                                <?php
                                                                                    if ($estados != null):
                                                                                        foreach ($estados as $edo):
                                                                                            ?>
                                  <option value="<?php echo $edo->estadoID ?>" <?php echo ($edo->estadoID == $datosPersonales->estadoID) ? 'selected="selected"' : '' ?>>
                                    <?php echo $edo->nombreEstado ?>
                                  </option>
                                  <?php
                                    endforeach;
                                    endif;
                            ...
                            <div>
                              ...
                              <label style="margin-right:30px;">Pais:</label>
                              <select class="background_gris_mini validate[required]" name="idPais">
                          ...
                          <?php } else{ ?>
                            ...
                            <div id="form_envio">
                              <div>
                                <label>Nombre:</label>
                                <input class="background_gris_mini validate[required] updateDestino" name="nombre" type="text" value="<?php echo $direccion_envio->nombre ?>" style="margin-right:27px;" />
                                <label>Apellidos:</label>
                                <input class="background_gris_mini updateDestino" name="apellidos" type="text" value="<?php echo $direccion_envio->apellido ?>" />
                              </div>
                              <br>
                              <div>
                                <label style="margin-right:34px;">C.P:</label>
                                <input class="background_gris_mini validate[required] updateDestino" name="cp" type="text" value="<?php echo $direccion_envio->cp ?>" style="margin-right:28px;" />
                                <label style="margin-right:28px;">Calle:</label>
                                <input class="background_gris_mini validate[required] updateDestino" name="calle" type="text" value="<?php echo $direccion_envio->calle ?>" />
                              </div>
                              <br>
                              <div>
                                <label>Número:</label>
                                <input name="noExterior" class="background_gris_mini validate[required] updateDestino" type="text" value="<?php echo $direccion_envio->numero ?>" style="margin-right:28px;" />
                                <label style="margin-right:8px;">Colonia:</label>
                                <input class="background_gris_mini validate[required] updateDestino" type="text" name="colonia" value="<?php echo $direccion_envio->colonia ?>" />
                              </div>
                              <br>
                              <div>
                                <label>Ciudad:</label>
                                <input class="background_gris_mini validate[required] updateDestino" type="text" name="ciudad" value="<?php echo $direccion_envio->ciudad ?>" style=" margin-right:31px;" />
                                <label style="margin-right:14px;">Estado:</label>
                                <select class="background_gris_mini validate[required] destino updateDestino" name="idEstado">
                                  <option> ---</option>
                                <?php
                                  if ($estados != null)
                                    foreach ($estados as $edo):
                                ?>
                                    <option value="<?php echo $edo->estadoID ?>" <?php echo ($edo->estadoID == $direccion_envio->estadoID) ? 'selected="selected"' : '' ?>>
                                      <?php echo $edo->nombreEstado ?>
                                   </option>
                                    <?php
                                        endforeach;
                ...
                <tr>
                  <th colspan="4"> IVA </th>
                  <th> $&nbsp;
                    <?php echo round($iva, 2); ?>
                  </th>
                </tr>
                <tr>
                  <th colspan="4"> TOTAL </th>
                  <th> $&nbsp;
                    <?php echo $carritototal->totalPrecio+ $costo; ?>
                  </th>
                </tr>
                <?php else: ?>
                  <tr>
        ...
        <ul class="mp_boton" style="display:none">
          <li>
            ...
            <a href="<?php echo $preference['response']['sandbox_init_point']; ?>" name="MP-Checkout" class="green-M-Rn" mp-mode="modal" onreturn="execute_my_onreturn" style="padding: 0px; float:right;">Pagar</a>
