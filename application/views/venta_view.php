<style>.title_paquetes_titilos_mini {  float: left !important;  width: 200px !important;  line-height: 1em !important;  margin-top: -175px !important;  font-family: "titulos" !important;  font-size: 15px !important;  margin-left: 45px !important;  margin-bottom: -10px !important;}.descipcion_pasos_mediano{  width: 840px;  min-height: 650px;  background-color: #FFF;  border: 0px solid #FFFFFF !important;   margin-top: 0px !important;}#paso_dos > div > div.paquetes_izquierda_mini > label > div.precio_paquete_lite_mini > div {    color:#E95D0F !important;}@-moz-document url-prefix() {    .iconos_paquetes_mini {        margin-bottom: 0px;        padding-top: 2px;        width: 100%;        height: 63px;        overflow: hidden;    }    #paso_dos > div > div.paquetes_izquierda_mini > label > div.precio_paquete_lite_mini > div {        color: #E95D0F !important;        margin: -152px 20px 0 0;        position: relative;    }    .precio_paquete_regular_mini {        margin: -152px 20px 0px 0px;        position: relative;    }    .precio_paquete_premium_mini {        margin: -152px 20px 0px 0px;        position: relative;    }}</style>
