...
if (navigator.userAgent.toLowerCase().indexOf('chrome') > -1){
  ...
  document.write('<link type="text/css" rel="stylesheet" href="<?=base_url()?>css/general.css" media="screen"></link> <link type="text/css" rel="stylesheet" href="<?=base_url()?>css/venta.css" media="screen"></link> <link type="text/css" rel="stylesheet" href="<?=base_url()?>css/tienda.css" media="screen"></link>');
  }
  </script>
...
jQuery(document).ready(function(){
	 ...
	 $(".contenedor_producto").click(function() {
             muestra('contenedor_detalle_anuncio');
     });
...
<div id="contenedor_detalle_anuncio" class="contenedor_detalle_anuncio" style="display:none">
<form action="<?=base_url()?>usuario/cuenta/carrito" method="post">
...
<div class="contenedor_galeria_producto">
 ...
 <div id="slideshow_producto" class="picse">
       <img src="<?=base_url()?>images/productos/01/01.png" width="279" height="279"/>
       <img src="<?=base_url()?>images/productos/01/01.png" width="279" height="279"/>
       <img src="<?=base_url()?>images/productos/01/01.png" width="279" height="279"/>
       <img src="<?=base_url()?>images/productos/01/01.png" width="279" height="279"/>
    </div>
...
Alimentador automático hecho de plástico muy fuerte.
Se puede programar fácilmente para que alimente a tu mascota hasta 3 veces al día.
Las porciones se pueden programar desde 50 grs hasta 600 grs, en múltiplos de 50 grs.
Fácil ensamble.
Requiere baterias no incluidas (3 "D")
</div>
<div class="costo_producto">
<font style=" padding-left:10px;">  $2500.00</font>
<font style="float:right; padding-right:10px;"> MX </font>
</div>
<div class="contenedor_select_producto">
<select class="select_producto" name="talle">
<option style="color: #CCC"> Seleccione la talla </option>
<option> Chica </option>
...
<option style="color: #CCC"> Selecciona el color </option>
<option > Verde </option>
<option > Azul </option>
</select>
</div>
...
<img src="<?=base_url()?>images/pago_lite.png"/>
</div>
...
<div class="sub_instrucciones_pasos"> <img style=" margin-left:15px;" src="<?=base_url()?>images/mini_cupon.png"/> Cupones disponibles <font> 2 </font> </div>
<div style="padding:15px;">
...
<li>
<a href="<?=base_url()?>venta.html"> Venta </a>
</li>
<li>
Cruza
</li>
...
<img src="<?=base_url()?>images/productos/01.png"/>
</div>
<div class="contenedor_descripcion_precio_producto">
<font class="nombre_producto"><?=$producto->nombre;?></font>
<br>
<font class="precio_producto"><?='$'.$producto->precio;?></font>
</div>
...
<div class="contenedor_producto">
<div class="contenedor_picture">
<img src="<?=base_url()?>images/productos/02.png"/>
</div>
<div class="contenedor_descripcion_precio_producto">
<font class="nombre_producto">Jaula -00909</font>
<br>
<font class="precio_producto"> $250.00 </font>
</div>
...
<div class="contenedor_producto">
<div class="contenedor_picture">
<img src="<?=base_url()?>images/productos/03.png"/>
</div>
<div class="contenedor_descripcion_precio_producto">
<font class="nombre_producto">Despachador -00909</font>
<br>
<font class="precio_producto"> $2500.00 </font>
</div>
...
<div class="contenedor_producto">
<div class="contenedor_picture">
<img src="<?=base_url()?>images/productos/04.png"/>
</div>
<div class="contenedor_descripcion_precio_producto">
<font class="nombre_producto">Correra-00909</font>
<br>
<font class="precio_producto"> $30.00 </font>
</div>
...
<div class="contenedor_descripcion_precio_producto">
<font class="nombre_producto">Shampoo -00909</font>
<br>
<font class="precio_producto"> $25.00 </font>
</div>
