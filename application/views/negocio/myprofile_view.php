...
<li class="cupones">
<p style="margin-top:5px; margin-left:10px;"><a id="cupones" href="<?=base_url()?>negocio/principal/cupones/" style="text-decoration:none;color:white;" class="ajaxLink"> Cupones</a> </p>
</li>
<li class="favoritos">
<p style="margin-top:5px; margin-left:10px;"><a id="favoritos" href="<?=base_url()?>negocio/principal/favoritos/" style="text-decoration:none;color:white;" class="ajaxLink">Favoritos</a> </p>
</li>
<li class="soporte">
<p style="margin-top:5px; margin-left:10px;"><a id="soporte" href="<?=base_url()?>negocio/principal/soporte/" style="text-decoration:none;color:white;" class="ajaxLink">Soporte Tecnico</a> </p>
</li>
<li class="facturas">
<p style="margin-top:5px; margin-left:10px;"><a id="facturas" href="<?=base_url()?>negocio/principal/facturas/" style="text-decoration:none;color:white;" class="ajaxLink">Mis Facturas</a> </p>
</li>
</ul>
