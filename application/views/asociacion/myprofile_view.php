...
$('#editarContrasena').submit(function(e) {
			e.preventDefault();
			$.ajax({
				url : "<?=base_url()?>asociaciones/principal/editar_contrasena",
				type : 'POST',
				dataType : 'json',
				data : $(this).serialize(),
...
<p style="margin-top:13px; margin-left:10px;"><a id="mi_perfil" href="<?=base_url()?>asociaciones/principal/miPerfil/" style="text-decoration:none;color:white;" class="ajaxLink">Mi Perfil</a></p>
</li>
<li class="anuncios">
<p style="margin-top:5px; margin-left:10px;"><a id="anuncios" href="<?=base_url()?>asociaciones/principal/anuncios/" style="text-decoration:none;color:white;" class="ajaxLink"> Admin. Anuncios</a> </p>
</li>
<li class="mensajes">
<p style="margin-top:5px; margin-left:10px;"><a id="mensajes" href="<?=base_url()?>asociaciones/principal/mensajes/" style="text-decoration:none;color:white;" class="ajaxLink"> Mensajes</a> </p>
</li>
<li class="cupones">
<p style="margin-top:5px; margin-left:10px;"><a id="cupones" href="<?=base_url()?>asociaciones/principal/cupones/" style="text-decoration:none;color:white;" class="ajaxLink"> Cupones</a> </p>
</li>
<li class="favoritos">
<p style="margin-top:5px; margin-left:10px;"><a id="favoritos" href="<?=base_url()?>asociaciones/principal/favoritos/" style="text-decoration:none;color:white;" class="ajaxLink">Favoritos</a> </p>
</li>
<li class="soporte">
<p style="margin-top:5px; margin-left:10px;"><a id="soporte" href="<?=base_url()?>asociaciones/principal/soporte/" style="text-decoration:none;color:white;" class="ajaxLink">Soporte Tecnico</a> </p>
</li>
<li class="facturas">
<p style="margin-top:5px; margin-left:10px;"><a id="facturas" href="<?=base_url()?>asociaciones/principal/facturas/" style="text-decoration:none;color:white;" class="ajaxLink">Mis Facturas</a> </p>
</li>
</ul>
