...
<form style = "margin-top:-160px;" action="<?= base_url() ?>asociaciones/principal/updateMiPerfilB" id="mpB" method="post">
...
<form style = "margin-top:0px;" action="<?= base_url() ?>asociaciones/principal/updateMiPerfilF" id="mpB" method="post">
